...
templates/preprocessors. The default template/preprocessor will be overriden if the file
found in your folder has the same name. Still, you'll need to enable your theme which has 
the same name as your sub-folder in the mainlab_tripal administrative interface.
