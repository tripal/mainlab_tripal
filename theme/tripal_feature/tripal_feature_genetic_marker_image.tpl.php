...
$icon_path = file_directory_path() . '/bulk_data/www.cottongen.org/cotton_photo/genetic_marker/icon/icon-';
$img_path = file_directory_path() . '/bulk_data/www.cottongen.org/cotton_photo/genetic_marker/image/';
